				...
				<div class="nux-in">
					...
					<div class="j-row goto">
						<div class="feat j-col j-lrg-7 j-md-8 j-sm-7">
							...
							<?php else : ?>
								<input type="submit" name="manage-cta-disabled" id="manage-cta-disabled" class="button button-primary" value="<?php _e( 'Activate features', 'jetpack' ); ?>" title="<?php esc_attr_e( 'Activate free WordPress.com features', 'jetpack' ); ?>">
							<?php endif; ?>
						</div>
